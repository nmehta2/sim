...
##### (PK profile of 100 mg oral, SD (t=0), CL = 0.05 L/hr, V= 1 L, ka = 0.5/hr, F =0.8)
```{r}
...
##### (PK profile of 100 mg oral, SD (t=0), CL = 0.1, 0.075, 0.05 L/hr, V=1, ka = 0.5/hr, F = 0.8)
```{r}
...
### 2e. Overlay plot of patient with normal bioavailability and decreased bioavailability after consuming high fat meal.
##### (PK profile of 100 mg oral, LD (t=0), MD (q=6 hr), CL = 0.1 L/hr, V = 1 L, ka = 0.5/hr, F=0.8, 0.4)
```{r}
combined_output_2_f <- bind_rows(res2 %>% mutate(profile = "100 mg Q6, F=0.8"),
                                 res2c %>% mutate(profile = "100 mg Q6, F=0.4 after 48 hours"))
...
### 3e. Overlay plot of patient with normal bioavailability and decreased bioavailability after consuming high fat meal.
...
### 4e. Overlay plot of patient with normal bioavailability and decreased bioavailability after consuming high fat meal.
##### (PK profile of 100 mg oral, LD (t=0), MD (q=6 hr), CL = 0.1 L/hr, V = 1 L, ka = 0.5/hr, F=0.8, 0.4)
```{r}
