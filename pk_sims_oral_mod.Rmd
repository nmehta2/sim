...
## 1d. Overlay plot of patient with normal bioavailability and decreased bioavailability
### (PK profile of 100 mg oral, SD(t=0), CL = 0.1 L/hr, Ka = 0.8, 0.4)
```{r}
...
### (PK profile of 100 mg oral, LD (t=0), MD (q=6 hr), CL = 0.1 L/hr, V = 1 L, ka = 0.5/hr, F=0.8, 0.4)
```{r}
combined_output_3_f <- bind_rows(res3 %>% mutate(profile = "100 mg Q24, F=0.8"),
                                 res3c %>% mutate(profile = "100 mg Q24, F=0.4"))
