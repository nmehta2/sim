...
```
## 1a. Patient has half of normal clearance (PK profile of 100 mg iv bolus (sd), CL = 0.05 L/hr, V= 1 L)
```{r}
adm1a <- list(time=c(0), amount=100)
t1a <- seq(0, 120, by=0.1)
param1a <- c(V=1, Cl=0.05)
...
## 1b. Patient's clearance drops by 25%. (PK profile of 100 mg iv bolus (sd), CL3 = 0.075 L/hr, V = 1 L)
```{r}

```
## 1c. Overlay PK profile of 100 mg iv bolus (sd), CL1 = 0.1 L/hr, CL2 = 0.05 L/hr, CL3 = 0.075 L/hr
```{r}
