...
## 4c. Overlay PK profiles of patient with normal clearance and decreased clearance (PK profile of 100 mg iv bolus, LD(t=0), MD (q=24hr), V = 1 L, CL = 0.1 L/hr, 0.05 L/hr, 0.075 L/hr)
```{r}
...
## 5c. Patient consumes a high fat meal 48 hours after beginning treatment, which reduces bioavailability by 50%. (PK profile of 100)

## 5d. Overlay plot of patient with decreased clearance and normal clearance. (PK profile of 100 mg oral, SD (t=0), CL = 1, 0.075, 0.05 L/hr, V=1, Ka = 0.8)

## 5e. Overlay plot of patient with normal bioavailability and decreased bioavailability (PK profile of 100 mg oral, SD(t=0), CL = 1 L/hr, Ka = 0.8, 0.4)
